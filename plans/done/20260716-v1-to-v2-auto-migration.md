...
- Delete v1 surfaces per `plans/done/v1-v2-delete-patterns-audit.md`: `workspace/`+`workspaces/` routes, `WorkspaceSidebar`, v1 `ChatPane`, v1 workspace data layer; then `packages/chat` and `packages/mcp` per `plans/done/v1-to-v2-fast-migration.md` P6.
