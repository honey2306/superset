...
`plans/done/20260724-v1-v2-terminal-fusion.md` (the terminal-only fusion that
preceded this one).
...
- [x] (2026-07-26) M1 task 5 root cause located AND fixed on this branch.
  ...
  **Fix:** wired the existing D2 headless migrator `runV1Migration`
  ...
  (`plans/done/20260716-v1-to-v2-auto-migration.md`), but scoped to M1's need
...
- `gateComplete` (D4/D5) is meant to eventually flip `useIsV2CloudEnabled`
  ...
  (`plans/done/20260716-v1-to-v2-auto-migration.md` unchecked items)
