...
function DropdownMenuItem({
	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cn(
				// DS MenuItem: 30px height, 10px h-padding, r-3, hover reveals --hover,
				// danger swaps color+tint, keyboard shortcut sits right of the label.
