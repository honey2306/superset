...
const COMPUTER_USE_INSTRUCTIONS = [
	...
	"computer_window restore/focus recovers known Peekaboo window-identity failures through one Dock activation and verifies the exact restored window. computer_verify_state polls structured Accessibility state for the requested window; satisfied requires stable matching samples, and unknown/unsatisfied are not success.",
].join(" ");
