 ...
 * against the `workspaceLocalState` TanStack DB collection.
 */
 ...
 * against the `workspaceLocalState` TanStack DB collection, and only
...
/**
 * The pure, testable core of the Host-backed panes persistence adapter.
 *
 ...
 * `workspaceLocalState` collection; this core has no collection/Electron
