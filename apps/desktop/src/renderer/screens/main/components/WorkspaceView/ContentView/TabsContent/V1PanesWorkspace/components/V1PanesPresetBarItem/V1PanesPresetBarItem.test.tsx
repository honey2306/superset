...
let V1PanesPresetBarItem: ComponentType<ItemProps>;
...
beforeAll(async () => {
	...
	({ V1PanesPresetBarItem } = await import("./V1PanesPresetBarItem"));
});
...
function renderItems({
	...
	if (!sourceId || !targetId) {
		throw new Error("V1 preset item handler IDs were not exposed");
	}
	return {
...
describe("V1PanesPresetBarItem context menu", () => {
...
describe("V1PanesPresetBarItem drag wiring", () => {
