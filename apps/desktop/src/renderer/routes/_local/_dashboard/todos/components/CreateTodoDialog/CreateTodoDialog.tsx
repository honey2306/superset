...
import { localAutomationKeys } from "renderer/routes/_local/_dashboard/hooks/useLocalAutomationData";
...
export function CreateTodoDialog({
	...
	const { machineId: targetHostId, activeHostUrl: hostUrl } =
		useLocalHostService();
	...
	const createMutation = useMutation({
		mutationFn: () => {
			...
			return getHostServiceClientByUrl(hostUrl).todos.create.mutate({
				...
				projectId: mode === "auto" ? (selectedProjectId ?? null) : null,
				workspaceId: mode === "auto" && !isTemporaryTarget ? workspaceId : null,
