			...
			<Tooltip delayDuration={300}>
				<TooltipTrigger asChild>
					<button
						...
						disabled={!canGoBack}
						className="no-drag flex items-center justify-center size-7 rounded-ds-3 text-fg-mute hover:text-fg hover:bg-hover transition-colors disabled:opacity-30 disabled:pointer-events-none"
					>
