...
import { LuClock3, LuEllipsis, LuGitBranch, LuSparkles } from "react-icons/lu";
import type {
	LocalAutomation,
	LocalAutomationRun,
...
interface AutomationRowProps {
	...
	lastRunStatus: LocalAutomationRun["status"] | null;
	isOwner: boolean;
	onRunNow: (automation: LocalAutomation) => void;
	onDelete: (automation: LocalAutomation) => void;
}

const LAST_RUN_META: Record<
	LocalAutomationRun["status"],
		...
		<ContextMenu>
			<ContextMenuTrigger asChild>
				...
				>
					...
					<TableCell className="text-xs text-fg-mute">
						<AgentCell agentId={automation.agent} hostId={machineId} />
					</TableCell>
