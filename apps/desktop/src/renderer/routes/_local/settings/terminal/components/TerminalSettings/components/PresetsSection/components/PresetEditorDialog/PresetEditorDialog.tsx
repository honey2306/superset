...
import { AGENT_CONFIGS_QUERY_KEY } from "renderer/hooks/useAgentConfigs";
import {
	findLinkedAgent,
	getAgentCommandText,
...
import type { PresetColumnKey } from "renderer/routes/_local/settings/presets/types";
...
export function PresetEditorDialog({
	...
	const queryFamily = { queryKey: AGENT_CONFIGS_QUERY_KEY };
