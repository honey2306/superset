...
const WRAPPER_CLASS =
	"flex flex-wrap items-center gap-x-4 gap-y-2 rounded-ds-3 border border-warning/40 bg-warning/10 px-3 py-2 text-xs leading-relaxed text-fg-mute select-text cursor-text";
