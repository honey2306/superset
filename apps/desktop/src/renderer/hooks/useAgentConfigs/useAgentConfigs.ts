...
export const AGENT_CONFIGS_QUERY_KEY = ["host-agent-configs"] as const;
 ...
 */
export function useAgentConfigs(hostUrl: string | null) {
	return useQuery({
		queryKey: [...AGENT_CONFIGS_QUERY_KEY, hostUrl] as const,
		enabled: !!hostUrl,
		queryFn: () => {
