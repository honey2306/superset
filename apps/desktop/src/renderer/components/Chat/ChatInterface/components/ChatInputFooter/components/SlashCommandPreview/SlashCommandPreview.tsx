...
export function SlashCommandPreview({
	...
	return (
		<div className="w-full px-3 pb-1">
			<div className="rounded-ds-3 border border-line/70 bg-hover/25 px-3 py-2">
				<div className="mb-2 flex items-center gap-2 text-fg-mute text-xs">
				...
				<div className="mt-2 space-y-1">
					<div className="text-[11px] text-fg-mute uppercase tracking-wide">
						{t("slashCommand.promptPreview")}
					</div>
					<div className="max-h-32 overflow-y-auto whitespace-pre-wrap rounded border border-line/70 bg-background/70 px-2 py-1.5 font-mono text-xs text-fg-mute">
						{previewPrompt}
					</div>
				</div>
			</div>
