			...
			>
				{showMermaidToggle && (
					<button
						...
						className="flex items-center justify-center rounded p-1.5 text-fg-mute transition-colors hover:bg-hover hover:text-fg"
					>
						{mermaidMode === "preview" ? (
				...
				<DropdownMenu open={menuOpen} onOpenChange={setMenuOpen}>
					<DropdownMenuTrigger asChild>
						<button
							type="button"
							className="flex items-center gap-1 rounded px-2 py-1 text-fg-mute text-xs transition-colors hover:bg-hover hover:text-fg"
						>
							{currentLabel}
