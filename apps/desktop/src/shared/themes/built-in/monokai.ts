...
export const monokaiTheme: Theme = {
	...
	ui: {
		...
		// Accent — brand green tint (14%), never a fill.
		accent: "rgba(166, 226, 46, 0.14)",
		accentForeground: "#a6e22e",
		tertiary: "#1e1f1c",
		...
		input: "#49483e",
		ring: "#a6e22e",
		// Note: ring stays brand-green even after DS realignment.
		sidebar: "#1e1f1c",
		sidebarForeground: "#f8f8f2",
		sidebarPrimary: "#a6e22e",
		sidebarPrimaryForeground: "#272822",
		sidebarAccent: "rgba(166, 226, 46, 0.14)",
		sidebarAccentForeground: "#a6e22e",
